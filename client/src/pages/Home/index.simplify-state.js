...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        axios.post("/auth/local/protected").then(res => {
            ...
            if (res.status === 200) {
                ...
                this.props.globalUpdateUsername(this.state.userData.username);
            } 

        })
        .then(() => {
            if(this.state.userData[userType]==="volunteer"){
    ...
    render() {
        if(this.state.userData[loggedIn])
        {
            return (
                        ...
                        <Col size="md-6" align="center">
                            ...
                            <h2>
                                <FormattedMessage id="homepage.home-welcome"
                                        ...
                                        values = {{ name: this.state.userData[firstname]}} />
                            </h2>
                            <p>
